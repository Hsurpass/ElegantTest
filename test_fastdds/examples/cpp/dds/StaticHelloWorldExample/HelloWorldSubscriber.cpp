...
bool HelloWorldSubscriber::init()
{
    ...
    std::string xml_file = "file://HelloWorldPublisher_static_disc.xml";
    DomainParticipantFactory* factory = DomainParticipantFactory::get_instance();
    if (factory->check_xml_static_discovery(xml_file) != ReturnCode_t::RETCODE_OK) {
        std::cout << "Error parsing xml file " << xml_file << std::endl;
    }
    pqos.wire_protocol().builtin.discovery_config.static_edp_xml_config(xml_file.c_str());
