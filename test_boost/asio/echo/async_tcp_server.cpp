...
void do_write(boost::asio::ip::tcp::socket& socket, int seq);
...
int main()
{
    ...
    boost::asio::ip::tcp::socket connsocket(io_context);

    boost::asio::ip::tcp::endpoint ep(boost::asio::ip::tcp::v4(), 1234);
    boost::asio::ip::tcp::acceptor acceptor(io_context, ep);
    acceptor.async_accept(connsocket, boost::bind(on_accept, boost::ref(connsocket), boost::asio::placeholders::error));
