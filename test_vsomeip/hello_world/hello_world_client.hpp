...
public:
    ...
    bool init()
    {
        ...
        app_->register_availability_handler(service_id,
                                            service_instance_id,
                                            std::bind(&hello_world_client::on_availability_cbk,
                                                      this,
                                                      std::placeholders::_1,
                                                      std::placeholders::_2,
                                                      std::placeholders::_3));
    ...
    {
        cout << "-----state: " << ((uint8_t)_state ? "ST_DEREGISTERED" : "ST_REGISTERED") << endl;
        if (_state == vsomeip::state_type_e::ST_REGISTERED) {
            ...
            cout << "-----request service:" << service_id << "." << service_instance_id << endl;
    ...
    {
        cout << "-----" << __func__ << ", service_id: " << _service << "instance_id:" << _instance
             << "_is_available: " << (_is_available ? "true" : "false") << endl;
