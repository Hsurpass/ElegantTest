...
public:
    void judge()
    {
        ...
        std::cout << "int: " << std::is_reference<T>::value << std::endl;
        std::cout << "int: " << std::is_lvalue_reference<T>::value << std::endl;
        std::cout << "int: " << std::is_rvalue_reference<T>::value << std::endl;
