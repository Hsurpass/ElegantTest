...
void test_equal_range()
{
    ...
    for_each(r.first, r.second, [](unordered_multimap<A, int, hash_A>::value_type& x) {
...
void test_equal_range_with_string()
{
    ...
    stringmap myumm = {{"orange", "FL"}, {"strawberry", "LA"}, {"strawberry", "OK"}, {"pumpkin", "NH"}};
    ...
    for_each(range.first, range.second, [](stringmap::value_type& x) {
...
void test_size()
{
    std::unordered_multimap<std::string, std::string> myumm = {{"Smith", "Pharmacy"},
                                                               {"Jones", "Library"},
                                                               {"Dole", "Church"},
                                                               {"Smith", "Office"},
                                                               {"Smith", "Office"}};
