...
typedef struct Point {
	int x, y;
#ifdef __cplusplus
	Point& set(int x_, int y_) { this->x = x_, this->y = y_; return *this; }
	void invalidate() { this->x = INT_MAX, this->y = INT_MAX; }
	bool isValid() { return this->x != INT_MAX || this->y != INT_MAX; }
	void setZero() { this->x = this->y = 0; }
	bool isZero() { return this->x == 0 && this->y == 0; }
	void offset(int x_, int y_) { this->x += x_; this->y += y_; }
	void offset(Point offset) { this->x += offset.x; this->y += offset.y; }
#endif
} Point;
...
static PointD PointD_make(double x, double y) { PointD o; o.x = x; o.y = y; return o; }
